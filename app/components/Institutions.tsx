      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 md:mb-16">
          ...
          <motion.h2
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif text-navy leading-tight mb-3 md:mb-5"
          >
            Three Pathways to{" "}
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-6 hidden">
          {/* Large Feature Card */}
          <motion.div
          ...
          >
            <Link href={institutions[0].href} className="group block h-full">
              <div className="relative h-full min-h-[280px] lg:min-h-[580px] rounded-3xl overflow-hidden">
                <Image
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex flex-wrap gap-2">
                      {institutions[0].programs.map((p) => (
                        <span
                          key={p}
                          className="text-[10px] font-sans font-bold uppercase tracking-wider px-3 py-1 rounded-full bg-white/10 text-white/80 backdrop-blur-sm border border-white/10"
                        >
                          {p}
                        </span>
                      ))}
          ...
          {institutions.slice(1).map((inst, index) => (
            ...
            >
              <Link href={inst.href} className="group block">
                <div className="relative h-[200px] md:h-[280px] rounded-3xl overflow-hidden">
                  <Image
                    src={inst.image}
                    alt={inst.name}
                    fill
        ...
        <div className="lg:hidden flex gap-4 overflow-x-auto snap-container scrollbar-hide pb-4 -mx-4 px-4">
          {institutions.map((inst, i) => (
            <motion.div
              ...
              className="snap-item shrink-0 w-[280px] sm:w-[340px]"
            >
              <Link href={inst.href} className="group block">
                <div className="relative h-[320px] sm:h-[360px] rounded-2xl overflow-hidden">
                  <Image
                    src={inst.image}
                    alt={inst.name}
                    fill
                  ...
                  <div className="absolute inset-0 p-5 flex flex-col justify-end z-10">
                    ...
                    <h3 className="text-lg font-serif font-bold text-white mb-1.5 leading-tight">
                      {inst.name}
                    </h3>
                    <p className="text-white/60 font-sans text-xs mb-3">
                      {inst.tagline}
                    </p>
                    <div className="flex flex-wrap gap-1.5">
                      {inst.programs.map((p) => (
                        <span
                          key={p}
                          className="text-[9px] font-sans font-bold uppercase tracking-wider px-2.5 py-0.5 rounded-full bg-white/10 text-white/70 border border-white/10"
                        >
                          {p}
                        </span>
                      ))}
