...
export default function EngineeringPage() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground overflow-x-hidden engineering-theme">
      ...
      <section
        ref={heroRef}
        className="relative min-h-[90vh] md:min-h-screen flex items-center overflow-hidden bg-[#0F172A]"
      >
        <motion.div
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="max-w-2xl">
              ...
              >
                <Button
                  size="lg"
                  className="h-12 md:h-14 px-8 bg-[#FBBF24] text-[#0F172A] hover:bg-[#F59E0B] font-bold rounded-xl transition-all hover:scale-105 active:scale-95 shadow-xl shadow-[#FBBF24]/20 w-full sm:w-auto"
                >
            ...
            >
              {[
                ...
                >
                  <span
                    className={`block text-2xl md:text-4xl font-sans font-black mb-1 md:mb-2 ${s.accent ? "text-[#FBBF24]" : "text-white"}`}
                  >
                    {s.val}
                  </span>
      ...
      <section className="py-12 md:py-16 bg-white relative">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div>
              <h2 className="text-xs font-bold tracking-[0.2em] uppercase text-[#FBBF24] mb-4">
                Engineering Domains
              </h2>
              ...
              >
                <div className="flex flex-col gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-serif text-primary font-bold">
                        {dept.name}
                      </h3>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-14">
            ...
            <h3 className="text-3xl md:text-4xl font-serif text-white leading-tight">
              Performance That{" "}
              <span className="text-white/40 italic font-light">Speaks.</span>
            </h3>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {metrics.map((m, index) => (
              ...
              >
                <span className="block text-3xl font-sans font-black text-accent mb-1">
                  {m.value}
                </span>
                <span className="block text-sm text-white font-bold mb-1">
                  {m.label}
                </span>
              ...
              {facilities.map((fac, index) => (
                ...
                >
                  <div className="flex flex-col gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-serif text-primary font-bold mb-2">
                        {fac.title}
                      </h3>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h3 className="text-4xl md:text-5xl font-serif text-primary leading-tight mb-6">
              From Campus to{" "}
              <span className="text-stone-300 italic font-light">Career.</span>
            </h3>
            ...
            {[
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-3xl font-sans font-black text-primary">
                    {s.val}
                  </span>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <div className="space-y-4 mb-10">
                {[
                  ...
                  <div key={s.step} className="flex gap-4 items-start">
                    <span className="text-accent font-sans font-black text-lg">
                      {s.step}
                    </span>
                    <p className="text-white/70 font-light text-sm pt-1">
                      {s.text}
                    </p>
                  </div>
                ))}
              ...
              <div className="flex flex-wrap gap-4">
                <Button
                  size="lg"
                  className="h-14 px-8 bg-accent text-primary hover:bg-accent/90 font-bold rounded-2xl transition-all hover:scale-105 active:scale-95 shadow-xl shadow-accent/20"
                >
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="h-14 px-8 border-white/20 bg-transparent text-white hover:bg-white/10 font-bold rounded-2xl"
                >
                  Management Quota
                </Button>
              </div>
