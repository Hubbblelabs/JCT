          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="max-w-2xl">
              ...
              >
                <Button
                  size="lg"
                  className="h-12 md:h-14 px-8 bg-[#14B8A6] text-white hover:bg-[#0D9488] font-bold rounded-xl transition-all hover:scale-105 active:scale-95 shadow-xl shadow-[#14B8A6]/20 w-full sm:w-auto"
                >
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="h-12 md:h-14 px-8 bg-white/5 backdrop-blur-sm border-white/20 text-white hover:bg-white/10 font-bold rounded-xl w-full sm:w-auto"
                >
                  Download Brochure
                </Button>
              </motion.div>
            ...
            >
              {[
                ...
                >
                  <span className="block text-2xl md:text-4xl font-sans font-black text-[#5EEAD4] tracking-tight mb-1 md:mb-2">
                    {stat.value}
                  </span>
                  <h3 className="text-[10px] md:text-xs font-bold text-white/90 uppercase tracking-wider mb-1">
                    {stat.label}
                  </h3>
                ...
                <div>
                  <div className="flex items-start justify-between mb-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-lg font-serif text-primary font-bold leading-tight">
                          {prog.name}
                        </h3>
                  ...
                  <div className="mb-5">
                    <span className="text-[10px] font-bold uppercase tracking-[0.15em] text-amber-600 mb-3 block">
                      What You'll Learn
                    </span>
                    <div className="grid grid-cols-1 gap-2">
                      {prog.outcomes.slice(0, 3).map((outcome) => (
                        <div
                          key={outcome}
                          className="flex items-center gap-2 text-sm text-stone-600 font-light"
                        >
                          <CheckCircle2
                            size={13}
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h3 className="text-4xl md:text-5xl font-serif text-primary leading-tight">
              Where Training{" "}
              <span className="italic text-stone-300 font-light">Happens</span>
            </h3>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <h3 className="text-4xl md:text-5xl font-serif leading-tight mb-10">
                Two Clear Roads{" "}
                <span className="text-white/60 italic font-light">Forward</span>
              </h3>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                ...
                <Link
                  ...
                  className="text-accent text-sm font-bold inline-flex items-center gap-1 hover:underline"
                >
                ...
                <div className="space-y-8 mb-10">
                  {[
                    ...
                    <div key={item.step} className="flex gap-5">
                      <span className="text-3xl font-sans font-black text-accent/30">
                        {item.step}
                      </span>
                      <div>
                        <h3 className="font-serif text-lg text-primary font-bold mb-1">
                          {item.title}
                        </h3>
                        <p className="text-stone-500 text-sm font-light leading-relaxed">
                          {item.desc}
            ...
            >
              ...
              <form className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <input
                    type="text"
                    className="w-full px-4 py-3.5 rounded-xl bg-white border border-stone-200 focus:border-accent focus:ring-1 focus:ring-accent/50 transition-all outline-none text-sm"
                ...
                <textarea
                  rows={3}
                  className="w-full px-4 py-3.5 rounded-xl bg-white border border-stone-200 focus:border-accent focus:ring-1 focus:ring-accent/50 transition-all outline-none text-sm resize-none"
              ...
              <div className="mt-6 pt-6 border-t border-stone-200 flex flex-col sm:flex-row gap-4 text-sm">
                <a
                  ...
                  className="flex items-center gap-2 text-stone-500 hover:text-primary transition-colors"
                >
