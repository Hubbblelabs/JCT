...
const ugPrograms = [
  {
    ...
    duration: "3 Years",
    icon: Calculator,
    desc: "Pure and applied mathematics with an emphasis on analytical reasoning, statistics, and computational methods.",
  },
  {
    name: "B.Sc Computer Science",
    duration: "3 Years",
    icon: Atom,
    desc: "Programming, data structures, software development, and database systems — with lab-intensive coursework each semester.",
  },
  {
    name: "B.Com (General / CA)",
    duration: "3 Years",
    icon: BarChart3,
    desc: "Accounting, taxation, financial management, and business law. The CA track includes computerized accounting modules.",
  },
  {
    name: "BBA",
    duration: "3 Years",
    icon: Briefcase,
    desc: "Management principles, marketing, organizational behavior, and entrepreneurship with case-study driven pedagogy.",
  },
  {
    name: "B.A English Literature",
    duration: "3 Years",
    icon: Languages,
    desc: "Critical reading, literary analysis, creative writing, and communication skills rooted in classical and modern texts.",
  },
  {
    name: "B.Sc Physics",
    duration: "3 Years",
    icon: FlaskConical,
    desc: "Classical mechanics, electrodynamics, quantum physics, and optics with dedicated laboratory sessions every week.",
  },
];
...
const pgPrograms = [
  {
    ...
    duration: "2 Years",
    icon: Calculator,
    desc: "Advanced algebra, real analysis, topology, and research methodology for students pursuing academic or analytical careers.",
  },
  {
    name: "M.Com",
    duration: "2 Years",
    icon: BarChart3,
    desc: "Advanced commerce studies covering cost accounting, auditing, international trade, and financial statement analysis.",
  },
  {
    name: "M.Sc Computer Science",
    duration: "2 Years",
    icon: Atom,
    desc: "Advanced computing, machine learning fundamentals, network security, and a research project in the final semester.",
  },
];
      ...
      <section className="relative min-h-[90vh] md:min-h-screen flex items-center overflow-hidden bg-[#1E1B4B]">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at 20% 50%, transparent 0%, transparent 2%, #A78BFA 2%, #A78BFA 2.2%, transparent 2.2%)",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="max-w-2xl">
              ...
              >
                Where Curiosity <br />
                Becomes{" "}
                <span className="text-[#A78BFA] italic font-light">
                  Understanding.
                </span>
              </motion.h1>
              ...
              >
                We offer undergraduate and postgraduate programs across science,
                commerce, and the humanities. The emphasis here is on thinking
                clearly, reading widely, and developing the discipline to pursue
              ...
              >
                <Button
                  size="lg"
                  className="h-12 md:h-14 px-8 bg-[#C4B5FD] text-[#1E1B4B] hover:bg-[#A78BFA] font-bold rounded-xl transition-all hover:scale-105 active:scale-95 shadow-xl shadow-[#C4B5FD]/20 w-full sm:w-auto"
                >
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="h-12 md:h-14 px-8 border-white/20 bg-white/5 backdrop-blur-sm text-white hover:bg-white/10 font-bold rounded-xl w-full sm:w-auto"
                >
                  Campus Tour
                </Button>
              </motion.div>
            ...
            >
              {[
                ...
                >
                  <span
                    className={`block text-2xl md:text-4xl font-sans font-black mb-1 md:mb-2 ${stat.accent ? "text-[#C4B5FD]" : "text-white"}`}
                  >
                    {stat.value}
                  </span>
                  <span className="text-[10px] md:text-xs text-white/60 font-bold uppercase tracking-wider">
                    {stat.label}
                  </span>
                </div>
              ))}
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <h3 className="text-4xl md:text-5xl font-serif text-primary leading-tight mb-10">
                Education That{" "}
                <span className="text-stone-500 italic font-light">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-stone-600 text-xl leading-relaxed font-light mb-8">
                  JCT College of Arts and Science was founded with a
                  straightforward idea: that good education doesn't just fill
                  notebooks — it changes how students think. Our programs in
                  science, commerce, and the humanities are designed to develop
                  analytical minds and responsible citizens.
                </p>
                <p className="text-stone-600 text-xl leading-relaxed font-light mb-8">
                  We're affiliated with Bharathiar University, Coimbatore, and
                  recognized by the UGC. The campus shares infrastructure with
                  the broader JCT Institutions ecosystem, giving our students
                  access to facilities and opportunities beyond a typical arts
                  and science college.
                </p>
                <p className="text-stone-500 text-lg leading-relaxed font-light">
                  Small class sizes mean faculty know their students by name.
                  Discussions happen naturally, and nobody gets lost in a crowd.
                  We don't claim to be the biggest — we aim to be the most
                  thoughtful.
                </p>
              </div>
              ...
              <div className="mt-14 pt-10 border-t border-stone-200 grid grid-cols-2 sm:grid-cols-3 gap-6 sm:gap-8">
                <div>
                  <span className="block text-4xl font-sans font-black text-primary mb-1">
                    6
                  </span>
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="mb-10 md:mb-12">
            <h2 className="text-xs font-bold tracking-[0.2em] uppercase text-amber-600 mb-4 md:mb-6">
              Undergraduate Programs
            </h2>
            <h3 className="text-3xl sm:text-4xl md:text-5xl font-serif text-primary leading-tight mb-4 md:mb-6">
              Six Paths <br />
              <span className="text-stone-300 italic font-light">
                to a Degree
              </span>
            </h3>
            <div className="flex flex-col md:flex-row gap-8 justify-between items-end">
              <p className="text-stone-500 font-light leading-relaxed text-lg max-w-2xl">
                Three-year programs that build strong foundations in theory and
                application — from pure mathematics to English literature, from
                physics labs to business case studies.
              </p>
              <div className="p-4 bg-stone-50 rounded-xl border border-stone-100 text-sm text-stone-500 font-light leading-relaxed max-w-sm">
                <span className="text-primary font-bold">Affiliated to</span>{" "}
            ...
            {ugPrograms.map((prog, index) => (
              ...
              >
                <div>
                  <div className="flex items-start gap-5 mb-6">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-serif text-primary font-bold leading-tight mb-2">
                        {prog.name}
                      </h3>
                ...
                <div className="flex justify-end pt-4 border-t border-stone-50">
                  <ArrowRight
                    size={18}
                    className="text-stone-300 group-hover:text-accent group-hover:translate-x-1 transition-all"
                  />
                </div>
              </motion.div>
            ))}
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
            ...
            <p className="text-stone-500 font-light text-sm max-w-md">
              Two-year programs for research exposure, advanced study, and
              preparation for competitive exams or academic careers.
            </p>
          </div>
            ...
            {pgPrograms.map((prog, index) => (
              ...
              >
                <div>
                  ...
                  <h3 className="text-xl font-serif text-primary mb-3 font-bold">
                    {prog.name}
                  </h3>
                  <p className="text-stone-500 text-sm font-light leading-relaxed mb-4">
                    {prog.desc}
                ...
                <div className="flex justify-end pt-4 border-t border-stone-50">
                  <ArrowRight
                    size={18}
                    className="text-stone-300 hover:text-accent transition-colors"
                  />
                </div>
              </motion.div>
            ))}
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-10 md:mb-16">
            <h2 className="text-xs font-bold tracking-[0.2em] uppercase text-amber-600 mb-6">
            ...
            <p className="text-stone-500 font-light leading-relaxed">
              Academic growth doesn't stop at lectures. These are the activities
              and spaces that make learning richer.
            </p>
          </div>
          ...
          <DragScroll className="flex gap-6 pb-8 -mx-4 px-4 md:mx-0 md:px-0 snap-x snap-mandatory scroll-smooth">
            {academicLife.map((item, index) => (
              ...
              >
                ...
                <h3 className="text-lg font-serif text-primary mb-2 font-bold">
                  {item.title}
                </h3>
      ...
      <section className="relative h-[50vh] min-h-100 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            ...
            <span className="block mt-4 text-sm text-white/50 font-bold uppercase tracking-widest">
              — Socrates
            </span>
          </motion.div>
        </div>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left mb-12">
              {[
                ...
                >
                  <h3 className="font-serif text-lg text-primary font-bold mb-4">
                    {block.title}
                  </h3>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
              <Button
                size="lg"
                className="h-14 px-10 bg-accent text-primary hover:bg-accent/90 font-bold rounded-2xl transition-all hover:scale-105 active:scale-95 shadow-xl shadow-accent/20"
              >
              ...
              <Button
                variant="outline"
                size="lg"
                className="h-14 px-10 border-stone-200 text-primary hover:bg-stone-50/80 font-bold rounded-2xl"
              >
                Download Prospectus
              </Button>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl border border-stone-100 max-w-md mx-auto">
              ...
              <div className="space-y-3 text-sm">
                <a
                  ...
                  className="flex items-center gap-3 text-stone-500 hover:text-primary transition-colors"
                >
