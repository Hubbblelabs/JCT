...
export const testimonials = [
  {
    quote: "The education here prepared me for real challenges. I walked into my first job feeling confident and capable, all thanks to the rigorous curriculum and supportive faculty.",
    name: "Rajesh Kumar",
    role: "Engineering at TCS",
    image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=200&auto=format&fit=crop"
  },
  {
    quote: "I came here uncertain about my direction. The diverse environment and the mentorship I received helped me discover my true passion and shape my career path.",
    name: "Priya Sharma",
    role: "Management at Accenture",
    image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=200&auto=format&fit=crop"
  },
  {
    quote: "The faculty understood that we needed more than theory. The hands-on projects and industry connections gave me the exact experience I needed to stand out.",
    name: "Arjun Patel",
...
export const newsUpdates = [
  {
    ...
    title: "Annual Science Exhibition showcases student innovations capable of global impact.",
    image: "https://images.unsplash.com/photo-1532094349884-543bc11b234d?q=80&w=600&auto=format&fit=crop"
  },
  {
    date: "Mon 20 Mar 2024",
    title: "National Commerce Conference hosted on campus, drawing industry leaders.",
    image: "https://images.unsplash.com/photo-1475721028070-96695bce1356?q=80&w=600&auto=format&fit=crop"
  },
  {
    date: "Wed 05 Apr 2024",
    title: "New AI and Machine Learning lab inaugurated to boost advanced research capabilities.",
