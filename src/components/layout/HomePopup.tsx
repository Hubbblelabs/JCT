...
import { X, ArrowRight, Award, Megaphone } from "lucide-react";
          ...
          >
            ...
            <div className="flex w-full flex-col justify-center p-8 md:w-1/2 md:p-12">
              ...
              <h2 className="text-navy mb-4 font-serif text-3xl font-bold md:text-4xl">
                Start Your Journey With JCT
              </h2>

              <p className="mb-8 text-stone-600">
                Applications are now open for Engineering, Arts & Science, and
                Polytechnic programs. Secure your future with our
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                ...
                <Link
                  ...
                  onClick={handleClose}
                  className="text-navy inline-flex items-center justify-center gap-2 rounded-full border-2 border-stone-200 bg-white px-6 py-3 font-sans text-sm font-bold transition-colors hover:border-stone-300 hover:bg-stone-50"
                >
                  View Programs
                </Link>
              </div>
