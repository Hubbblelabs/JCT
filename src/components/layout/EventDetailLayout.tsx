      ...
      <div className="container mx-auto max-w-4xl px-4 md:px-8">
        ...
        >
          ...
          {event.descriptionHtml && (
            <div
              className="text-foreground/90 font-sans text-base leading-relaxed [&_a]:text-accent [&_a]:underline [&_a]:underline-offset-2 [&_blockquote]:border-accent [&_blockquote]:text-muted-foreground [&_blockquote]:my-4 [&_blockquote]:border-l-4 [&_blockquote]:pl-4 [&_blockquote]:italic [&_h2]:text-foreground [&_h2]:mt-8 [&_h2]:mb-3 [&_h2]:font-serif [&_h2]:text-2xl [&_h2]:italic [&_h3]:text-foreground [&_h3]:mt-6 [&_h3]:mb-2 [&_h3]:font-serif [&_h3]:text-xl [&_h3]:italic [&_hr]:border-border [&_hr]:my-8 [&_li]:mb-1.5 [&_ol]:mb-4 [&_ol]:list-decimal [&_ol]:pl-6 [&_p]:mb-4 [&_table]:mb-4 [&_table]:w-full [&_td]:border-border [&_td]:border [&_td]:px-3 [&_td]:py-2 [&_th]:border-border [&_th]:bg-muted [&_th]:border [&_th]:px-3 [&_th]:py-2 [&_th]:text-left [&_ul]:mb-4 [&_ul]:list-disc [&_ul]:pl-6"
