          ...
          <div className="mt-8 min-w-0 space-y-16 lg:mt-0">
            ...
            >
              ...
              <div className="text-muted-foreground mb-8 space-y-4 text-base leading-relaxed md:text-lg">
                <p>
                  The Office of the Controller of Examinations (CoE) carries the
                  key responsibility of meticulously Planning, Organizing, and
                  Conducting the Continuous Internal Assessments (CIA),
                  Practical / Project Viva-Voce Examinations, and the End
                  Semester Examinations (ESE) for all undergraduate (UG),
                  postgraduate (PG), and research programmes at JCT College of
                  Engineering and Technology.
                </p>
                <p>
                  Under our autonomous stream, the office ensures that the
                  detailed Regulations, Curriculum, and Syllabi are consolidated
                  following approvals from the department Board of Studies
                  (BoS), Standing Committee (SC), Academic Council (AC), and
                  Governing Council (GC). Academic Calendars are precisely
                  structured to set teaching schedules, Continuous Internal
                  Assessment slots, and ESE sessions in alignment with the
                  schedules of Anna University, Chennai.
                </p>
                <p>
                  Assessments are conducted with utmost security,
                  confidentiality, and transparency. The CIA is organized twice
                  or thrice per semester (including a comprehensive Model
                  Examination), while the ESE is conducted at the end of each
                  semester. Backed by a highly dedicated Exam Cell team, the COE
                  office delivers error-free evaluation and graduation
                  processes.
                </p>
              </div>
                ...
                <div className="flex flex-col gap-6 p-5 sm:flex-row sm:items-start md:p-8">
                  ...
                  <div className="flex-1 space-y-4">
                    <blockquote className="border-gold/50 border-l-4 pl-5 text-base leading-relaxed text-blue-500 italic md:text-lg">
                      &quot;Our office stands dedicated to upholding absolute
                      integrity, confidentiality, and rigorous quality standards
                      under the autonomous regulations of the institution.&quot;
                    </blockquote>
                    <p className="text-muted-foreground text-sm leading-relaxed md:text-base">
                      As an autonomous college, JCT implements a robust
                      assessment system aligned with Outcome Based Education
                      (OBE) and Revised Bloom&apos;s Taxonomy. Our dedicated
                      team ensures timely exam scheduling, absolute
                      transparency, and smooth valuation.
                    </p>
                    <p className="text-muted-foreground text-sm leading-relaxed md:text-base">
                      We integrate digital frameworks for students database
                      mapping, question paper setter selections, central
                      dummy-number valuation, and web-portal entries,
                      encouraging a highly efficient and standardized evaluation
                      workflow.
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                ...
                <div className="rounded-3xl border border-white/10 bg-white/5 p-6 md:p-8">
                  <div className="mb-6 flex items-center gap-3 border-b border-white/5 pb-4">
                    ...
                    <div>
                      <h3 className="text-foreground text-lg leading-none font-bold">
                        Post-Examination & Evaluation Phase
                      </h3>
                      <span className="text-gold text-[10px] font-bold tracking-wider uppercase">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground space-y-4 text-sm leading-relaxed md:text-base">
                    <p className="font-serif text-blue-500 italic">
                      &quot;In a nutshell, our entire
                      Teaching-Learning-Evaluation (TLE) process adopts as well
                      as implements with a focussed Outcome Based Education
                      (OBE) and its associated outcomes.&quot;
                    </p>
                    <p>
                      At JCT College of Engineering and Technology, all
                      assessments—including Continuous Internal Assessments
                      (CIA), practical exams, project work, and End Semester
                      Examinations (ESE)—are mapped strictly to clear Course
                      Outcomes (COs), Program Outcomes (POs), and Program
                      Specific Outcomes (PSOs).
                    </p>
                    <p>
                      This ensures that students acquire not just theoretical
                      concepts, but industry-ready cognitive abilities,
                      problem-solving skills, and global engineering
                      competencies under the autonomous assessment stream.
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <p className="text-muted-foreground mb-8 text-sm leading-relaxed md:text-base">
                Find the latest autonomous stream academic schedules,
                revaluation circulars, and application forms from the Controller
