...
async function getData(): Promise<GroupsPageValue> {
  return getPublishedConfig("engineeringCommittees", GroupsPageSchema, EMPTY);
}
...
export async function generateMetadata({
  ...
  return seoMetadata({
    scope: "engineering",
    path: `/institutions/engineering/committees/${slug}`,
    fallbackTitle: found
      ? `${found.group.name} | JCT College of Engineering & Technology`
      : "Committees | JCT College of Engineering & Technology",
    fallbackDescription:
      found?.group.description ||
      "Institutional committee at JCT College of Engineering & Technology, Coimbatore.",
  });
}
...
export default async function CommitteeDetailPage({
  ...
  return <GroupDetailLayout group={found.group} variant="committees" />;
}
