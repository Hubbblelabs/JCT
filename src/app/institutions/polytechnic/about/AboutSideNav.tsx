    ...
    <>
      ...
      <div className="bg-surface border-border hidden rounded-3xl border p-6 lg:block">
        ...
        <Link
          ...
          className="bg-polytechnic mt-6 flex w-full items-center justify-center gap-2 rounded-xl py-4 text-center font-bold text-white transition-colors hover:opacity-90"
        >
          Apply Now
