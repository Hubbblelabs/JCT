...
export async function generateMetadata({
  ...
  return seoMetadata({
    scope: "polytechnic",
    path: `/institutions/polytechnic/committees/${slug}`,
    fallbackTitle: found
      ? `${found.group.name} | JCT Polytechnic College`
      : "Committees & Cells | JCT Polytechnic College",
    fallbackDescription:
      found?.group.description ||
      "Committee at JCT Polytechnic College, Coimbatore.",
  });
}

export default async function PolytechnicCommitteeDetailPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
