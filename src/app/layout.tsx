    ...
    <html lang="en" suppressHydrationWarning>
      ...
      >
        ...
        <a
          ...
          className="fixed right-4 bottom-5 z-50 flex aspect-square h-12 w-12 items-center justify-center rounded-full bg-[#25D366] shadow-xl shadow-[#25D366]/20 transition-transform hover:scale-105 active:scale-95 md:right-6 md:bottom-6"
        >
          <svg
