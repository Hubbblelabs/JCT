...
export const metadata: Metadata = {
  ...
  description:
    "Connect with the JCT alumni network, alumni initiatives, mentoring programs, annual meets, and alumni testimonials.",
  openGraph: {
    title: `Alumni Network | ${siteConfig.name}`,
    description:
      "Connect with the JCT alumni network, alumni initiatives, mentoring programs, annual meets, and alumni testimonials.",
          ...
          <section className="rounded-3xl border border-white/10 bg-white/5 p-8 lg:p-12">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              {[
                ...
                {
                  quote:
                    "JCT provided me not just with an engineering degree, but with a platform to develop my overall personality. The placement training and symposiums helped build my confidence, which was key to cracking my core company interview.",
                  name: "R. Praveen",
                  role: "Mechanical Engineering Batch (2013-2017)",
                },
              ].map((testimonial) => (
                <div
                  key={testimonial.name}
                  className="bg-surface relative rounded-2xl border border-white/5 p-6"
                >
