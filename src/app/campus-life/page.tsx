...
export default function CampusLifePage() {
  return (
    <main className="bg-background selection:bg-gold selection:text-navy min-h-screen overflow-x-hidden">
        ...
        <section className="section-padding grid items-center gap-16 lg:grid-cols-2">
          <motion.div {...slideInLeft}>
            ...
            <p className="text-muted-foreground mt-6 text-lg leading-relaxed">
              At JCT Institutions, we believe that education extends far beyond
              the four walls of a classroom. Our campus is a living laboratory
              where students evolve into leaders.
            </p>
              ...
              >
                <div className="group relative overflow-hidden rounded-[2rem] shadow-md transition-all hover:-translate-y-2 hover:shadow-2xl">
                  ...
                  <div className="absolute right-0 bottom-0 left-0 translate-y-4 p-8 text-white opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
                    ...
                    <div className="text-gold mt-2 flex items-center gap-2 text-sm font-medium">
      ...
      <section className="section-padding bg-surface/50 mx-4 my-12 rounded-[4rem] md:mx-6">
        <div className="container mx-auto px-4">
          <div className="mb-16 text-center">
            ...
            <p className="text-muted-foreground mx-auto mt-4 max-w-2xl text-sm md:text-base">
              Premium facilities designed for the comfort and efficiency of our
              students.
            </p>
          </div>
          ...
          <div className="grid items-center gap-16 lg:grid-cols-2">
            ...
            <motion.div {...slideInRight} className="order-1 lg:order-2">
              ...
              <p className="text-muted-foreground mt-8 text-lg leading-relaxed">
                A healthy body fuels a sharp mind. Our campus is built to push
                boundaries, fostering character and teamwork through every game.
              </p>
                ...
                <div className="relative z-10 flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-white/60">
                      A celebration of talent and grit with over 2000+
                      participants.
                    </p>
                  </div>
                </div>
      ...
      <section className="section-padding bg-navy mx-4 my-12 overflow-hidden rounded-[4rem] text-white md:mx-6">
        <div className="container mx-auto px-4">
          <div className="mb-16">
          ...
          <div className="space-y-16">
                ...
                <div className="grid gap-6 lg:grid-cols-2 lg:items-end">
                  <div>
                    ...
                    <p className="mt-4 max-w-xl text-sm text-white/70 md:text-lg">
                      Where creativity knows no bounds. Our members jam,
                      perform, and collaborate across disciplines, making every
                      day a performance.
                    </p>
                  </div>
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              ...
              >
                ...
                <div>
                  <h4 className="text-2xl font-bold md:text-3xl">JCTantra</h4>
                  <p className="mt-4 text-sm leading-relaxed text-white/60 md:text-lg">
                    National level technical symposium showcasing the
                    convergence of technical brilliance and innovation.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <h4 className="text-2xl font-bold md:text-3xl">Dhwani</h4>
                  <p className="mt-4 text-sm leading-relaxed text-white/60 md:text-lg">
                    The heart of JCT culture. A two-day carnival celebrating
                    music, dance, and theatrical arts.
                  </p>
                </div>
              </motion.div>
            </div>
      ...
      <section className="section-padding container mx-auto mb-12 px-4 md:px-6">
        <motion.div
          {...fadeIn}
        ...
        >
          ...
          <p className="text-navy/70 relative z-10 mt-6 max-w-2xl text-base font-medium md:text-lg">
            Join a community of visionaries and leaders. Admissions are now open
