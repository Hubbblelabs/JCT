    ...
    >
      ...
      >
        ...
        <div className="relative z-10 mb-10 flex justify-center">
          <div className="inline-flex rounded-full bg-white/80 p-1 shadow-sm border border-slate-200 backdrop-blur-sm">
            {tabs.map((tab) => (
              <button
                key={tab.key}
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-polytechnic-dark/80 font-sans text-base md:text-[17px] leading-relaxed italic">
                <p>
                  &ldquo;Welcome to JCT Polytechnic College. As we stand at the threshold of a rapidly advancing technological era, our objective is to equip our youth with the exact skills the modern industry demands. At our institution, we emphasize hands-on, practical learning above all else.&rdquo;
                </p>
                <p>
                  &ldquo;Our dedicated faculty ensures that our students are not only technically proficient but also imbibe strong ethical values. We have consistently produced a high placement record because we bridge the gap between the classroom and the factory floor from day one.&rdquo;
                </p>
                <p>
                  &ldquo;I invite you to explore our campus and witness the dedication to experiential learning that defines JCT Polytechnic. Let us work together to build a strong foundation for your future.&rdquo;
                </p>
              </div>
            </motion.div>
          </div>
