      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <motion.div
            ...
            className="max-w-xl"
          >
            <h3 className="text-arts-science-dark mb-6 font-sans text-3xl leading-tight font-bold sm:text-4xl md:text-5xl">
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <Button
                size="lg"
                className="from-gold-light to-gold h-14 w-full rounded-full border border-[#f1d892]/70 bg-linear-to-r px-8 font-bold text-[#70001b] shadow-[0_10px_24px_rgba(212,175,55,0.35)] transition-all hover:-translate-y-0.5 hover:brightness-95 sm:w-auto"
              >
                Learn
              </Button>
              <a
                href="#more"
                className="text-arts-science-dark mt-2 flex items-center justify-center px-4 text-sm font-semibold hover:underline sm:mt-0 sm:justify-start"
              >
