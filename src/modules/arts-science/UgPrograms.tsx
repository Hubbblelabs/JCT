      ...
      <div className="container relative mx-auto px-4 md:px-8">
        <div className="mb-20 flex flex-col items-center text-center">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 rounded-full border border-arts-science-accent/20 bg-arts-science-accent/5 px-4 py-2 text-arts-science-accent mb-6 shadow-sm"
          >
            <span className="h-2 w-2 rounded-full bg-arts-science-accent animate-pulse" />
          ...
          >
            {[...ugPrograms, ...ugPrograms, ...ugPrograms, ...ugPrograms].map((prog, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 z-0 bg-gradient-to-br from-arts-science-accent/5 via-white/95 to-white/90 opacity-0 transition-opacity duration-300 group-hover/card:opacity-100" />
                ...
                <div className="relative z-0 mb-8 flex flex-1 flex-col">
                  <div className="bg-slate-100 text-slate-600 group-hover:bg-arts-science-accent mb-6 flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl shadow-inner transition-colors duration-500 group-hover:text-white group-hover:shadow-arts-science-accent/30">
                ...
                <div className="relative z-0 border-slate-200 text-slate-500 group-hover:text-arts-science-accent mt-auto flex shrink-0 items-center justify-between border-t pt-5 font-medium transition-colors duration-300">
                  <span className="text-sm uppercase tracking-wider">Explore Program</span>
                  <span className="bg-slate-100 group-hover:bg-arts-science-accent/10 flex h-8 w-8 items-center justify-center rounded-full transition-colors duration-300">
        ...
        >
          <Link
            ...
            className="group relative overflow-hidden rounded-full bg-arts-science px-10 py-4 font-semibold text-white shadow-xl shadow-arts-science/20 transition-all hover:scale-105 active:scale-95"
          >
            <span className="relative z-10 flex items-center gap-3">
              Browse all programs
              <ArrowRight className="h-5 w-5 transition-transform duration-300 group-hover:translate-x-1" />
            </span>
            <div className="absolute inset-0 bg-gradient-to-r from-arts-science-accent/80 to-arts-science opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
          </Link>
        </motion.div>
      </div>
    </section>
