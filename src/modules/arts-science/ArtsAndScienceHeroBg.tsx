...
export function ArtsAndScienceHeroBg() {
  return (
    <div className="absolute inset-0 z-0 overflow-hidden bg-[#faf8fc] pointer-events-none">
      ...
      <div className="absolute bottom-[0%] right-[0%] w-[50%] h-[60%] rounded-full bg-purple-600/15 blur-[130px]" />
      <div className="absolute top-[30%] right-[5%] w-[40%] h-[40%] rounded-full bg-violet-500/15 blur-[120px]" />
      ...
      >
        <defs>
          ...
          <linearGradient id="contour2" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <stop offset="100%" stopColor="#d8b4fe" stopOpacity="0.9" />
          </linearGradient>
          ...
          <filter id="shadowDepth" x="-10%" y="-10%" width="120%" height="120%">
            <feDropShadow dx="-4" dy="-4" stdDeviation="16" floodColor="#3b0764" floodOpacity="0.08" />
          </filter>
        </defs>
