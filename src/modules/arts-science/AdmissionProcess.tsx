  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 z-0 mask-[radial-gradient(ellipse_at_center,black_60%,transparent_100%)]">
        <div className="absolute inset-0 bg-arts-science-accent/15 mask-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjQiIGhlaWdodD0iMjQiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PGNpcmNsZSBjeD0iMiIgY3k9IjIiIHI9IjEuNSIgZmlsbD0iYmxhY2siLz48L3N2Zz4=')] mask-size-[24px_24px]" />
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-6 md:p-10 shadow-xs backdrop-blur-md">
          <div className="flex flex-col gap-6 border-b border-slate-100 pb-8 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h3 className="text-arts-science font-serif text-3xl font-bold md:text-4xl leading-tight">
                Admission Process
              </h3>
            ...
            <a
              ...
              className="bg-arts-science-accent hover:bg-arts-science-accent-dark text-white font-semibold px-8 py-3.5 rounded-full flex items-center justify-center gap-2 transition-all shadow-xs w-full sm:w-auto self-start md:self-end shrink-0"
            >
              Apply Now
          ...
          <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
            {admissionsCriteria.map((block, index) => (
              ...
              >
                <h4 className="text-arts-science mb-4 text-[1.1rem] font-serif font-bold border-b border-slate-100 pb-2">
                  {block.title}
                </h4>
          ...
          >
            ...
            <a
              ...
              className="text-arts-science hover:text-arts-science-accent flex items-center gap-2.5 font-medium transition-colors"
            >
              <Mail size={16} className="text-arts-science-accent" /> admissions@jct.ac.in
            </a>
