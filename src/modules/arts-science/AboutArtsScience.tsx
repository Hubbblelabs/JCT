...
function ArtsSectionHeader({ title, description, centered = false }: { title: string; description?: string; centered?: boolean }) {
  return (
    <div className={cn("mb-10", centered ? "text-center" : "")}>
      <h2 className="text-arts-science-dark font-serif text-3xl leading-tight md:text-4xl font-bold">
        {title}
      </h2>
      {description && (
        <p className={cn("text-arts-science-dark/70 mt-3 max-w-3xl text-base leading-relaxed md:text-lg", centered ? "mx-auto" : "")}>
          {description}
        </p>
      )}
    </div>
...
export function AboutArtsScience() {
  ...
  return (
    ...
    >
      ...
      <ArtsSection tone="transparent" className="relative" id="vision-mission">
        <div className="relative z-10">
          <ArtsSectionHeader
            title="Vision & Mission"
            description="Guiding the intellectual and personal growth of tomorrow's leaders."
            centered={true}
          />
