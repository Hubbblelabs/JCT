          ...
          <div>
            ...
            <div className="space-y-4 text-base leading-relaxed text-stone-600 md:text-lg">
              <p>
                ...
                institution affiliated to Anna University, Chennai. Established
                with a vision to provide world-class technical education, the
                college offers{" "}
                <strong className="text-stone-800">
                  11 undergraduate
                </strong> and{" "}
                <strong className="text-stone-800">4 postgraduate</strong>{" "}
              ...
              <p>
                ...
                commitment to continuous improvement, JCT Engineering stands as
                a trusted name in technical education in Tamil Nadu.
              </p>
