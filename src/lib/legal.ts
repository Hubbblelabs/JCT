...
export const TRUST_NAME =
  "Shri Jagannath Educational Health and Charitable Trust";

export const TRUST_ADDRESS = "Pichanur, Coimbatore 641105, Tamilnadu, India";

export const SUPPORT_EMAIL = "support@jct.ac.in";

export const SITE_DOMAIN = "www.jct.ac.in";
